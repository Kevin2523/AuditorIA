# Planificacion - AuditorIA AI

Esta carpeta contiene los artefactos activos de planificacion para la evolucion SaaS de AuditorIA AI.
...
| [RFC-002-init.md](RFC-002-init.md) | RFC inicial de migracion hacia AuditorIA AI | Activo |
